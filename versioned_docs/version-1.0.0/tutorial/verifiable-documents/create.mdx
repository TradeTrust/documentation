...
- Using the [wallet created in the prerequisite step](/docs/tutorial/prerequisites#wallet-creation), we run this command on the CLI to retrieve the private key:
