...
> For the current step, you can either opt to use the [CLI](/docs/tutorial/transferable-records/wrapping-document/wrapping-document-cli) or [Code](/docs/tutorial/transferable-records/wrapping-document/wrapping-document-code).
