...
- (Advanced) Issue a TradeTrust Verifiable document that interacts with a [document store](/docs/4.x/tutorial/verifiable-documents/advanced/document-store/overview) (Ethereum Smart Contract).

### See Also

[Topics: Verifiable Document - Overview](/docs/4.x/topics/verifying-documents/overview)
