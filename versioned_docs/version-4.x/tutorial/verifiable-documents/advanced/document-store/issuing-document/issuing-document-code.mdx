...
pagination_next: tutorial/verifiable-documents/advanced/document-store/revoking-document/revoking-document-code
---
...
Refer to the [pre-requisite](/docs/tutorial/verifiable-documents/advanced/document-store/deploying-document-store/document-store-code) on document store deployment.
...
[Revoking of Verifiable Documents](/docs/tutorial/verifiable-documents/advanced/document-store/revoking-document/revoking-document-code)
