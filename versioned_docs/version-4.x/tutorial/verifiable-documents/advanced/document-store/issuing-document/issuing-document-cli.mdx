...
> For the current step, you can either opt to use the [CLI](/docs/4.x/tutorial/verifiable-documents/advanced/document-store/issuing-document/issuing-document-cli) or [Code](/docs/4.x/tutorial/verifiable-documents/advanced/document-store/issuing-document/issuing-document-code).
...
- `--hash` is the merkle root hash, for instance generated while [Wrapping Documents](/docs/4.x/tutorial/verifiable-documents/advanced/document-store/wrapping-document/wrapping-document-cli)
...
[Revoking of Verifiable Documents](/docs/4.x/tutorial/verifiable-documents/advanced/document-store/revoking-document/revoking-document-cli)
