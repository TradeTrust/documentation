...
- `--hash` is the value of `targetHash` field of one of the [previously wrapped documents](/docs/tutorial/verifiable-documents/advanced/document-store/wrapping-document/wrapping-document-cli) (open one of the file, head to the bottom and check for the `targetHash` in the `signature` object.
...
If you open the [previously wrapped documents](/docs/tutorial/verifiable-documents/advanced/document-store/wrapping-document/wrapping-document-cli) side by side, you will notice:
