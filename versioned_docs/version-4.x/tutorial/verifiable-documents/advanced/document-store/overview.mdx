...
- Issue a TradeTrust Verifiable document using [DNS-DID](/docs/4.x/topics/introduction/issuer-method-dns-did) method.
...
- [CLI](/docs/4.x/tutorial/verifiable-documents/advanced/document-store/deploying-document-store/document-store-cli)
- [Code](/docs/4.x/tutorial/verifiable-documents/advanced/document-store/deploying-document-store/document-store-code)
