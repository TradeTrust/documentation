...
`signDocument` takes a wrapped document, a wallet (public and private key pair) or an [Ethers.js Signer](https://docs.ethers.io/v5/api/signer/).
...
```js
import { signDocument, SUPPORTED_SIGNING_ALGORITHM } from '@tradetrust-tt/tradetrust-core'
