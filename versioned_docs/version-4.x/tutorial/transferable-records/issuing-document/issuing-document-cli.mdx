...
- [token registry address](/docs/4.x/tutorial/transferable-records/token-registry/token-registry-cli)
- [wallet private key file](/docs/4.x/tutorial/transferable-records/token-registry/token-registry-cli#creating-the-key-file) (key.txt)
- [merkle root](/docs/4.x/tutorial/transferable-records/wrapping-document/wrapping-document-cli) of the wrapped transferable record
...
```sh
tradetrust token-registry mint --address 0x8431012Bc040942B59e3C5bf428221eab0b2f723 --tokenId 0x0d9839a8034cb783d98bd57bcbaafb4dc3614c4193d2edf8a655c1ec6635b7ea --beneficiary 0x6FFeD6E6591b808130a9b248fEA32101b5220eca --holder 0x6FFeD6E6591b808130a9b248fEA32101b5220eca --network sepolia -f key.txt
```
