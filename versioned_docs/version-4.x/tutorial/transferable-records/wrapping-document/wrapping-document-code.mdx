...
pagination_next: tutorial/transferable-records/issuing-document/issuing-document-code
---
...
> For the current step, you can either opt to use the [CLI](/docs/4.x/tutorial/transferable-records/wrapping-document/wrapping-document-cli) or [Code](/docs/4.x/tutorial/transferable-records/wrapping-document/wrapping-document-code).
