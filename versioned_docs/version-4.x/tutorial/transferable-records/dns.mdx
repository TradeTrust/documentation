...
With your [token registry address](/docs/4.x/tutorial/transferable-records/token-registry/token-registry-cli) that you get from the previous step, run the following command:
