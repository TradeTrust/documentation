...
- [CLI](/docs/4.x/tutorial/transferable-records/token-registry/token-registry-cli)
- [Code](/docs/4.x/tutorial/transferable-records/token-registry/token-registry-code)
