...
- `"backgroundColor"` - Update with the desired background color. The default color will be used if color is not stated here. e.g. "#000000", "black"
- `"titleColor"` - Update with the desired title text color. The default color will be used if color is not stated here. e.g. "#ffffff", "white"
- `"descriptionColor"` - Update with the desired description text color. The default color will be used if color is not stated here. e.g. "#ffffff", "white"
