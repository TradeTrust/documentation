...
The wallet string should be displayed on your terminal and you can enter it into the `"wallet"` field in the [config file](/document-creator#configuration-file).
