...
_Note: you will need to have Open Attestation Cli installed._ This will give you a wallet.json.
...
"Account Details" and click "Export Private Key". You will be prompted to input your Metamask password. Once you have your private key,
...
```
You will then be prompted to key in your wallet password. Once entered, you will see a success message with the path to your wallet.json:
...
```
This result can now be entered into the `"wallet"` field in the config file.
