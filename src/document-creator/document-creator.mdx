...
Once you have an existing wallet.json, this is how you can serialise it into a string:

Using [this website](https://tools.knowledgewalls.com/jsontostring), copy the contents of your wallet.json and paste it in the field before clicking on the "Convert" button.
You should see a serialised version of your wallet.json in the output.

![tools-wallet-string](./tools-wallet-string.png)

3. If you have an existing Metamask account but don't want to use the Open Attestation Cli, you can still get your wallet string doing this:
    
    1. Get your private key from Metamask (_See option 2 if unsure_)
    2. Open your terminal
    3. Navigate to a repository that has `ether.js`
    4. Type these commands line by line in the terminal:
