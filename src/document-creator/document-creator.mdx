...
1. If you already have an existing wallet.json, this is how you can serialise it into a string:
...
2. If you have an existing Metamask account, you can get your wallet string using your private key:

    1. Open your terminal
    2. Navigate to a repository that has `ether.js`
