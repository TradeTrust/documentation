...
The TradeTrust Prototype development currently enters version 2 with the key components to be made available progressively.

![TradeTrust Prototype v2 Technology Roadmap](./TradeTrust-Prototype-v2-Technology-Roadmap.svg | width=800)
