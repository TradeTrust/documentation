...
TradeTrust envisions itself as a set of standards and software interfaces to facilitate trade movement digitally. The foundation required to accomplish this is the ability to trace the provenance of digitally issued documents as well as verify their integrity.
...
### Advanced Deed document topics

Possessor-Owner governance (TODO)
