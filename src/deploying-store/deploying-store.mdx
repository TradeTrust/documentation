...
There are 2 methods of deploying the store: [using the OA_CLI tool](#using-oa-cli-tool) and [using the admin site](#using-the-admin-site)
...
Alternatively, you to deploy a document store using the [admin site](https://admin.tradetrust.io).
