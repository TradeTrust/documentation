...
Refer to the [pre-requisite](/docs/tutorial/verifiable-documents/advanced/document-store/deploying-document-store/document-store-cli) on document store deployment.
