...
```bash
tradetrust sign ./unsigned-documents --output-dir ./signed-documents --public-key did:ethr:0xaCc51f664D647C9928196c4e33D46fd98FDaA91D#controller --key  0x7b227ac59116f3eeb2b265422cf3cbfbd244c525961fb297eb52153ec62aa845
```

In the example above:

- `public-key` the public key used [to bind the wallet address with the DNS location](/docs/tutorial/verifiable-documents/dns#creating-temporary-dns-proof-with-cli)
- `key` is the wallet private key, generated when [creating the wallet](/docs/tutorial/prerequisites#wallet-creation)
