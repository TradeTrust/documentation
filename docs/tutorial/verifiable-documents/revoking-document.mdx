...
- a deployed `documentStore`, click [here](/docs/) for how to do so.
...
- `--address` is the document store address, for instance the one created with the [Deploying Document Store](/docs/) guide.
