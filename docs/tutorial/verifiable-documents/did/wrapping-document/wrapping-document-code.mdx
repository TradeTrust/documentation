...
pagination_next: tutorial/verifiable-documents/did/signing-document/signing-document-code
---
...
> For the current step, you can either opt to use the [CLI](/docs/tutorial/verifiable-documents/did/cli/wrapping-document-cli) or [Code](/docs/tutorial/verifiable-documents/did/code/wrapping-document-code).
