...
pagination_next: tutorial/verifiable-documents/signing-document/signing-document-code
---
...
> For the current step, you can either opt to use the [CLI](/docs/tutorial/verifiable-documents/wrapping-document/wrapping-document-cli) or [Code](/docs/tutorial/verifiable-documents/wrapping-document/wrapping-document-code).
