...
> For the current step, you can either opt to use the [CLI](/docs/tutorial/advanced/verifiable-documents/ethereum/revoking-document) or [Code](/docs/tutorial/advanced/verifiable-documents/ethereum/revoking-document-code).
...
Refer to the [deploy document store](/docs/tutorial/advanced/verifiable-documents/ethereum/issuing-document-code.md) section on issue instructions.
