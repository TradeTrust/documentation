...
> For the current step, you can either opt to use the [CLI](/docs/tutorial/transferable-records/issuing-document-cli)
> or [Code](/docs/tutorial/transferable-records/issuing-document-code).
