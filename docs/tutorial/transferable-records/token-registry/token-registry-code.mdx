...
import { Wallet, ethers, TransactionReceipt } from "ethers";
...
const registryAddress = getEventFromReceipt<any>(receipt as unknown as TransactionReceipt, "Deployment", deployerContract.interface).args
  .deployed;
