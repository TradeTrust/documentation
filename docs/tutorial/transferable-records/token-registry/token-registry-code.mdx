...
const registryAddress = getEventFromReceipt<any>(receipt, (deployerContract as any).getEventTopic("TitleEscrowCreated"), deployerContract.interface).args.deployed;
