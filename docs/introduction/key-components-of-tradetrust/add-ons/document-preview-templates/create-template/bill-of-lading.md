...
- `"tokenRegistry"` - Update with your token registry. For more information, click [here](/docs/how-tos/open-attestation/transferable-records/token-registry/token-registry-cli).
