...
> For the current step, you can either opt to use the [CLI](/docs/key-components-of-tradetrust/w3c-vc/signing-documents/signing-document-cli) or [Code](/docs/key-components-of-tradetrust/w3c-vc/signing-documents/signing-document-code).
