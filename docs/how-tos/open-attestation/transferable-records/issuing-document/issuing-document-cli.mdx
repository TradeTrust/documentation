...
- [token registry address](/docs/how-tos/open-attestation/transferable-records/token-registry/token-registry-cli)
- [wallet private key file](/docs/how-tos/open-attestation/transferable-records/token-registry/token-registry-cli#creating-the-key-file) (key.txt)
- [merkle root](/docs/how-tos/open-attestation/transferable-records/wrapping-document/wrapping-document-cli) of the wrapped transferable record
