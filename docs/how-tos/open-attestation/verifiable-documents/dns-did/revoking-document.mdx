...
- The **document store address** is the address created with the [Deploying Document Store](/docs/how-tos/open-attestation/verifiable-documents/dns-did/advanced/document-store/deploying-document-store/document-store-cli) guide.
