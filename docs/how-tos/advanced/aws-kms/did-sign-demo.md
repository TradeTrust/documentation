...
Prepare an example document (can refer to [this](/docs/introduction/key-components-of-tradetrust/w3c-vc/tradetrust-document-schema#raw-document)) that is to be signed:
